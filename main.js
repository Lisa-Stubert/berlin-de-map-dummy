...
map.on('click', function(e) {
  ...
  var popup = new mapboxgl.Popup({ offset: [0, -15] })
    ...
    .setHTML('<h3>' + feature.properties['Wie heißt Ihr Projekt? Nennen Sie einen griffigen Namen.'] + '</h3><h4>Kategorie:</h4><p> ' + feature.properties['In welche Kategorie ordnen Sie Ihre Bewerbung ein? '] + '</p><h4>Behörde:</h4><p> ' + feature.properties['Aus welcher Behörde bewerben Sie sich für den Berliner Verwaltungspreis?'] + '</p>')
    .addTo(map);
});
